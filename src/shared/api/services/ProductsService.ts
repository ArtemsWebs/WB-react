...
export class ProductsService {
   ...
   * @throws ApiError
   */
  public static addProduct(requestBody: Product): CancelablePromise<Product> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/products",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static getProductById(id: number): CancelablePromise<Product> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/products/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static deleteProduct(id: number): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/products/{id}",
      path: {
